...
public final class JPasswordFieldLimitado extends JPasswordField {
	...
	public JPasswordFieldLimitado(int maximo) {
		super();
	...
	private void JPasswordFieldKeyTyped(KeyEvent evt) {
		...
		String caracteres = "0987654321abcdefghijklmnopqrstuvxyzABCDEFGHIJKLMNOPQRSTUVXYZ";// lista de caracters que não devem ser
											// aceitos
