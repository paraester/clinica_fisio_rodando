...
public final class JtextFieldLetrasNumeros extends JTextField {
	...
	public JtextFieldLetrasNumeros(int maximo) {
		super();
		setMaximoCaracteres(maximo);// define o tamanho máximo //que deve ser
									// aceito no jtextfield que foi recebido no
									// construtor
	...
	private void JPasswordFieldKeyTyped(KeyEvent evt) {
		...
		String caracteres = " 0987654321bcçdfghjklmnpqrstvwxyzBCÇDFGHJKLMNPQRSTVWXYZãaáâãAÁÂeéêẼEÉÊiíîĨIÍÎÎoóôÕOÓÔÕuúûU";// lista de caracters que não devem ser
											// aceitos
